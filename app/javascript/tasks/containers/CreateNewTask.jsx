...
import CreateNewTask from 'tasks/components/CreateNewTask.jsx'
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  createTask: (task) => dispatch([createTask({ ...task, projectId: ownProps.project.id }), clearTask(), removeCurrentTask()]),
